...
import * as errorHandler from './middlewares/errorHandler'; // Initialize Sentry
...
app.use(json); // API Routes

app.use('/api', routes); // Swagger UI
...
app.use('/api-docs', express.static(pathToSwaggerUi)); // This error handler must be before any other error middleware

app.use(Sentry.Handlers.errorHandler()); // Error Middlewares
